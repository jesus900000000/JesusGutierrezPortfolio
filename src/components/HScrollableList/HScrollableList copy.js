...
const projects = [
    ...
    { name: "Personal Portfolio (this site)", description: "Personal Website. Completely Designed, Developed, and Deployed by myself.", photo: "/ProjectImages/portfolio.png", codeLink: "" },
];
